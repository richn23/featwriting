...
const AI_POLICY: ScenarioTaskDef = {
  ...
  screens: [
    ...
    },
    {
      kind: "scenario",
      label: "AI output",
      title: "You receive this AI-generated client report",
      body: "Subject: Q1 Customer Retention Analysis\n\nSummary: Customer retention improved by 34% in Q1 compared to Q4. This was driven by the new loyalty programme launched in January.\n\nKey findings:\n1. 89% of surveyed customers reported satisfaction with the loyalty programme.\n2. Churn rate dropped from 12% to 8%.\n3. The loyalty programme is the clear cause of improved retention.\n4. Recommendation: Expand the programme to all regions immediately.\n\nThis report will be sent to the client tomorrow.",
    ...
    },
    {
      kind: "multi-select",
      label: "Evaluation",
      question: "What are the issues with this report? Select all that apply.",
      options: [
        { id: "a", text: "Assumes causation from correlation — retention could have other drivers", correct: true },
        { id: "b", text: "Survey satisfaction does not prove the programme caused retention", correct: true },
        { id: "c", text: "Recommends immediate expansion without considering cost, capacity, or risk", correct: true },
        { id: "d", text: "Presents a single explanation when multiple factors likely contributed", correct: true },
        { id: "e", text: "No issues — the data supports the conclusions", correct: false },
      ],
      requireJustification: true,
    ...
    },
    {
      ...
      body: "Your company has the following policy on AI-generated content:\n\n\u2022 AI can assist drafting but all output must be reviewed before external use\n\u2022 Claims must be supported by verified data and sound reasoning\n\u2022 Causal claims require evidence beyond correlation\n\u2022 Staff are responsible for all content sent to clients",
      pinAsReference: true,
    },
    {
      kind: "choice",
      label: "Policy check",
      question: "Is this report acceptable as-is under the policy?",
      options: [
        { id: "a", text: "Yes — it presents clear data and a recommendation", quality: "poor" },
        { id: "b", text: "No — it violates multiple policy requirements", quality: "best" },
        { id: "c", text: "Partially — it needs minor adjustments to tone", quality: "acceptable" },
        { id: "d", text: "The policy does not apply to client reports", quality: "poor" },
      ],
      requireJustification: true,
    ...
    },
    {
      kind: "short-text",
      label: "Adaptation",
      question: "Rewrite the summary and recommendation to fix the problems. Keep the data but make the reasoning sound.",
      constraints: [
        "Maximum 100 words",
        "Fix the causal claims",
        "Acknowledge other possible factors",
        "Make the recommendation proportionate",
      ],
      maxWords: 100,
      scoringHints: [
        "Removes or qualifies the causal claim",
        "Acknowledges that other factors may have contributed",
        "Recommends a measured next step (e.g. pilot, further analysis) rather than immediate expansion",
        "Maintains a professional and confident tone",
    ...
    },
    {
      kind: "choice",
      label: "Risk judgment",
      question: "What is the biggest risk if the original report is sent to the client unchanged?",
      options: [
        { id: "a", text: "Credibility damage — the client spots the flawed reasoning and loses trust", quality: "best" },
        { id: "b", text: "Bad decision-making — the client expands a programme based on unsound analysis", quality: "acceptable" },
        { id: "c", text: "Policy breach — staff are responsible for reviewed content", quality: "acceptable" },
        { id: "d", text: "No real risk — the client will appreciate the positive findings", quality: "poor" },
      ],
      requireJustification: true,
...
export const PROFESSIONAL_TASK_LIST = [OJT, AI_POLICY, INFO_PRIORITY];
